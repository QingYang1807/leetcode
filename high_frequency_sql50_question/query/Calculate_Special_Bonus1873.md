...
[地址](https://leetcode.cn/problems/calculate-special-bonus/solutions/1738928/by-youthful-6aussnpr-r3i8/)
...
```sql
select employee_id,
if (mod(employee_id,2)!=0 and left(name,1)!='M',salary,0) as bonus from Employees  
